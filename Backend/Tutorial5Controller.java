...
/**
 * Controller for the fifth tutorial scene in the application.
 *
 * <p>This class manages the functionality of the fifth tutorial scene, including
 * displaying the selected pet image, navigating to the previous and next scenes,
 * and initializing resources specific to this scene.</p>
 */
public class Tutorial5Controller {
    ...
    /**
     * Navigates back to the fourth tutorial scene.
     *
    ...
    /**
     * Advances to the sixth tutorial scene.
     *
     * <p>This method loads the sixth tutorial FXML file, sets the selected pet,
     * and updates the primary stage to display the new scene.</p>
     */
    @FXML
    private void next() {
